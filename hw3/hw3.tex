...
\begin{enumerate}
  ...
  \item
    ...
    \begin{solution}
      ...
      removing $e$ partitions $T$ into two sets. Therefore, we have a cut $(S, V \setminus S)$ which the edge $e$ crosses. Because $e$ is part of a
      ...
      By Theorem 23.1, $e'$ is a safe edge for \textbf{FINISH THIS ARGUMENT}
      Let $T' = T \setminus \{ e \} \cup \{ e' \}$. Then
